...
- Memory limits: 1Gi (dev), 3Gi (prod)
...
- Consistent naming pattern: `credit-scoring-engine-{env}`
...
- Image SHA digests are placeholders and should be replaced with actual values from your registry
